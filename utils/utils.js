        ...
        if (product !== undefined && product.OfferSummary !== undefined) {
            if (product.OfferSummary.TotalNew !== "0") {
                ...
                _product = {
                    ...
                    DescriptionCN: null,
                    Price: (product.Offers !== undefined) ? product.Offers.Offer.OfferListing.Price.Amount / 100 || null : null,
                    PriceCurrency: (product.Offers !== undefined) ? product.Offers.Offer.OfferListing.Price.CurrencyCode || null : null,
